...
export default function Home() {
  ...
  // Objetos de estilo embutidos para substituir o Tailwind
  const styles = {
    main: {
      ...
      <div style={styles.card}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ backgroundColor: '#0B1026', border: '2px solid rgba(255, 122, 0, 0.3)', borderRadius: '24px', padding: '16px', display: 'inline-block', marginBottom: '12px' }}>
            <img src="/logo.jpeg" alt="Chame o Técnico" style={{ h: '112px', height: '112px', objectFit: 'contain' }} />
          </div>
          <h1 style={{ fontSize: '24px', fontWeight: '900', color: '#FF7A00', uppercase: 'true', textTransform: 'uppercase', tracking: 'wider', fontStyle: 'italic', margin: '8px 0 4px 0' }}>
            Abertura de Chamado
          </h1>
          <p style={{ color: '#B8C0CC', fontSize: '13px', margin: 0 }}>Triagem profissional para suporte técnico especializado</p>
        </header>
            ...
            {categoria && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div style={{ marginTop: '8px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  <div style={{ border: '2px dashed #2E3B63', borderRadius: '12px', padding: '16px', backgroundColor: '#0B1026', textAlign: 'center', relative: 'true', position: 'relative' }}>
                    <input
                      type="file"
                      accept="image/*"
                      multiple
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: '14px', fontWeight: '500', color: '#white', display: 'block', margin: '4px 0' }}>Clique para anexar ou tirar foto</span>
